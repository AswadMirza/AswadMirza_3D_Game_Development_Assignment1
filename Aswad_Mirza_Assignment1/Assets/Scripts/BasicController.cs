...
public class BasicController : MonoBehaviour
{
	...
	// Bullet Force
	public Vector3 BulletForce = new Vector3(0, 10, 2000);
	// Bullet prefab
	...
	IEnumerator FireBullet()
	{
		...
		GameObject bullet = Instantiate(Bullet, GunTip.position, GunTip.rotation) as GameObject;
		//if (bullet.GetComponent<Rigidbody>())
		//    // IF the bullet prefab has a Rigidbody component, THEN destroy such component, making it kinematic
		//    Destroy(bullet.GetComponent<Rigidbody>());

		//// Disable the bullet's Sphere Collider component, to avoid collisions with the Character Controller
		...
		//// Add Rigidbody component to bullet
